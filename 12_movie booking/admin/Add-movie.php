  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
          ...
          <a href="./movie_adding.php.html"><button>Add Movies<a href="./movie_adding.html"></a></button>
        </div>
...
if (mysqli_num_rows($result) > 0) {
  while($row = mysqli_fetch_array($result)){
    ...
    <tr>
              ...
              <td><a href="./editMovie.php?id=<?php echo $id;?>"><button data-toggle="modal" type="button" class="btn btn-primary btn-sm">Edit Movie</button></a></td>
              <td><a href="./deleteMovie.php?id=<?php echo $id;?>"><button data-toggle="modal" type="button" class="btn btn-danger btn-sm">Delete Movie</button></a></td></td>
            </tr>
