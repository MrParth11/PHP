  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
        <a href="./Theater.html"><button>Add Show<a href="./Theater.html"></a></button>
...
if (mysqli_num_rows($result) > 0) {
  while($row = mysqli_fetch_array($result)) {
    ...
    <tr>
              ...
              <td>
                  <a href="./editShow.php?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm">Edit Show</button>
                  <a href="./deleteShow.php?id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">Delete Show</button>
               </td>
                </tr>
